        ...
        <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('student.grades.download', $grade->id) }}" 
                                       class="text-indigo-600 hover:text-indigo-900 mr-3">Download</a>
                                    <a href="{{ route('student.grades.view', $grade->id) }}" 
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-gray-500">Your grades will appear here once your teachers upload them.</p>
                </div>
            @endif
        </div>
    </div>
